...
ORG_NAME=Grainchain
configtxgen -outputAnchorPeersUpdate ./grainchain-peer-update.tx   -asOrg $ORG_NAME -channelID airlinechannel  -profile AirlineChannel

#6. Generate the anchor peer update budget
ORG_NAME=Commodity
configtxgen -outputAnchorPeersUpdate ./commodity-peer-update.tx   -asOrg $ORG_NAME -channelID airlinechannel  -profile AirlineChannel
